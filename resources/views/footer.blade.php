...
<!-- fullCalendar 2.2.5 -->
<script src="{{ URL::asset('Content/plugins/moment/moment.min.js') }}"></script>
<script src="{{ URL::asset('Content/plugins/fullcalendar/main.js') }}"></script>
...
<script src="{{ URL::asset('Content/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
<!-- Summernote -->
